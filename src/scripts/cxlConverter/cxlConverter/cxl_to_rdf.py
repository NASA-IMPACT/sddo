...
tree = ET.parse('./input/SMD_ConceptualIM20210122a.cxl')
...
#             print(prop_rel)
            ...
            ### SPECIAL CHARS ###
            if '&' in clean_concept_label:
                clean_concept_label = clean_concept_label.replace('&','&amp;')
        
            xml += '<smd:'+clean_prop_label+' rdf:resource="http://smd.dev/schema#'+clean_concept_label+'"/>'
