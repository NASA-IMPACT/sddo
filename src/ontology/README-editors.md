These notes are for the EDITORS of sddo
...
Make sure you have an ID range in the [idranges file](sddo-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [sddo-edit.owl](sddo-edit.owl)

** DO NOT EDIT sddo.obo OR sddo.owl in the top level directory **

[../../sddo.owl](../../sddo.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/aeleish/sddo) for details.
 ...
 * [sddo-idranges.owl](sddo-idranges.owl)
...
This generates derived files such as sddo.owl and sddo.obo and places
 ...
 * https://github.com/aeleish/sddo/releases
 * https://github.com/aeleish/sddo/releases/new
...
what is in the `owl:versionIRI` of the derived sddo.owl (`data-version` in
sddo.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/sddo.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/sddo/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/aeleish/sddo.svg?branch=master)](https://travis-ci.org/aeleish/sddo)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/aeleish](https://travis-ci.org/profile/aeleish)
 2. click the "Sync account" button
 3. Click the tick symbol next to sddo
